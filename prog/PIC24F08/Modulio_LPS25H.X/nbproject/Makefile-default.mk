...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Modulio_LPS25H.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=../Lib_Modulio/ACM1602.c ../Lib_Modulio/LPS25H.c ../Lib_Modulio/Modulio_Common.c ../Lib_Modulio/Modulio_HAL.c main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1009458742/ACM1602.o ${OBJECTDIR}/_ext/1009458742/LPS25H.o ${OBJECTDIR}/_ext/1009458742/Modulio_Common.o ${OBJECTDIR}/_ext/1009458742/Modulio_HAL.o ${OBJECTDIR}/main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1009458742/ACM1602.o.d ${OBJECTDIR}/_ext/1009458742/LPS25H.o.d ${OBJECTDIR}/_ext/1009458742/Modulio_Common.o.d ${OBJECTDIR}/_ext/1009458742/Modulio_HAL.o.d ${OBJECTDIR}/main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1009458742/ACM1602.o ${OBJECTDIR}/_ext/1009458742/LPS25H.o ${OBJECTDIR}/_ext/1009458742/Modulio_Common.o ${OBJECTDIR}/_ext/1009458742/Modulio_HAL.o ${OBJECTDIR}/main.o

# Source Files
SOURCEFILES=../Lib_Modulio/ACM1602.c ../Lib_Modulio/LPS25H.c ../Lib_Modulio/Modulio_Common.c ../Lib_Modulio/Modulio_HAL.c main.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Modulio_LPS25H.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/1009458742/LPS25H.o: ../Lib_Modulio/LPS25H.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1009458742" 
	@${RM} ${OBJECTDIR}/_ext/1009458742/LPS25H.o.d 
	@${RM} ${OBJECTDIR}/_ext/1009458742/LPS25H.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../Lib_Modulio/LPS25H.c  -o ${OBJECTDIR}/_ext/1009458742/LPS25H.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1009458742/LPS25H.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -I"../../../../../../../../../mnt/hgfs/TMP/Modulio/Proj/V6/PIC24F08" -I"../../../../../../../../../mnt/hgfs/TMP/Modulio/Proj/V6/PIC24F08/Lib_Modulio" -O1 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/_ext/1009458742/LPS25H.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Modulio_LPS25H.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Modulio_LPS25H.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -I"../../../../../../../../../mnt/hgfs/TMP/Modulio/Proj/V6/PIC24F08" -I"../../../../../../../../../mnt/hgfs/TMP/Modulio/Proj/V6/PIC24F08/Lib_Modulio"     -Wl,,,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_SIMULATOR=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Modulio_LPS25H.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Modulio_LPS25H.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -I"../../../../../../../../../mnt/hgfs/TMP/Modulio/Proj/V6/PIC24F08" -I"../../../../../../../../../mnt/hgfs/TMP/Modulio/Proj/V6/PIC24F08/Lib_Modulio" -Wl,,,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST) 
	${MP_CC_DIR}/xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/Modulio_LPS25H.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf  
