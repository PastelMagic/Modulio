...
export LoadConfig_modulio_adxl345
export _LoadConfig_modulio_adxl345
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_modulio_adxl345
	lcall	LoadConfigTBL_modulio_adxl345_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration modulio_adxl345
;
;    Load configuration registers for modulio_adxl345.
...
;               CUR_PP
;
_LoadConfig_modulio_adxl345:
 LoadConfig_modulio_adxl345:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_modulio_adxl345_Bank0
    mov     X, <LoadConfigTBL_modulio_adxl345_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_modulio_adxl345_Bank1
    mov     X, <LoadConfigTBL_modulio_adxl345_Bank1
