...
export LoadConfig_modulio_lps25h
export _LoadConfig_modulio_lps25h
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_modulio_lps25h
	lcall	LoadConfigTBL_modulio_lps25h_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration modulio_lps25h
;
;    Load configuration registers for modulio_lps25h.
...
;               CUR_PP
;
_LoadConfig_modulio_lps25h:
 LoadConfig_modulio_lps25h:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_modulio_lps25h_Bank0
    mov     X, <LoadConfigTBL_modulio_lps25h_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_modulio_lps25h_Bank1
    mov     X, <LoadConfigTBL_modulio_lps25h_Bank1
