...
export LoadConfigTBL_modulio_lps25h_Bank1
export LoadConfigTBL_modulio_lps25h_Bank0
export LoadConfigTBL_modulio_lps25h_Ordered
AREA lit(rom, rel)
LoadConfigTBL_modulio_lps25h_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_modulio_lps25h_Bank1:
;  Instance name I2CHW_1, User Module I2CHW
...
LoadConfigTBL_modulio_lps25h_Ordered:
