...
export LoadConfig_modulio_pca9632
export _LoadConfig_modulio_pca9632
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_modulio_pca9632
	lcall	LoadConfigTBL_modulio_pca9632_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration modulio_pca9632
;
;    Load configuration registers for modulio_pca9632.
...
;               CUR_PP
;
_LoadConfig_modulio_pca9632:
 LoadConfig_modulio_pca9632:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_modulio_pca9632_Bank0
    mov     X, <LoadConfigTBL_modulio_pca9632_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_modulio_pca9632_Bank1
    mov     X, <LoadConfigTBL_modulio_pca9632_Bank1
