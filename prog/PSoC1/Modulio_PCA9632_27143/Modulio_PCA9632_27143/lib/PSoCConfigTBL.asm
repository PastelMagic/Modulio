...
export LoadConfigTBL_modulio_pca9632_Bank1
export LoadConfigTBL_modulio_pca9632_Bank0
export LoadConfigTBL_modulio_pca9632_Ordered
AREA lit(rom, rel)
LoadConfigTBL_modulio_pca9632_Bank0:
...
;  Global Register values Bank 0
	...
	db		d6h, 48h		; I2CConfig register (I2CCFG)
	...
	db		ffh
LoadConfigTBL_modulio_pca9632_Bank1:
;  Instance name I2CHW_1, User Module I2CHW
...
LoadConfigTBL_modulio_pca9632_Ordered:
;  Ordered Global Register values
	M8C_SetBank0
	mov	reg[00h], 00h		; Port_0_Data register (PRT0DR)
	M8C_SetBank1
	mov	reg[00h], 00h		; Port_0_DriveMode_0 register (PRT0DM0)
	mov	reg[01h], 3ch		; Port_0_DriveMode_1 register (PRT0DM1)
	M8C_SetBank0
	mov	reg[03h], 3ch		; Port_0_DriveMode_2 register (PRT0DM2)
