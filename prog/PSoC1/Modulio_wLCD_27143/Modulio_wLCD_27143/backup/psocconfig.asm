...
export LoadConfig_modulio_wlcd
export _LoadConfig_modulio_wlcd
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_modulio_wlcd
	lcall	LoadConfigTBL_modulio_wlcd_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration modulio_wlcd
;
;    Load configuration registers for modulio_wlcd.
...
;               CUR_PP
;
_LoadConfig_modulio_wlcd:
 LoadConfig_modulio_wlcd:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_modulio_wlcd_Bank0
    mov     X, <LoadConfigTBL_modulio_wlcd_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_modulio_wlcd_Bank1
    mov     X, <LoadConfigTBL_modulio_wlcd_Bank1
