...
export    I2CHW_1_bReadBusStatus
export   _I2CHW_1_bReadBusStatus
...
I2CMSCR_NotReady1:
    ...
    jmp   CheckRxAck
DoRestartRx:
    call  I2CHW_1_DoBufferRepeatStart                           ; Send a repeat start and address.
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: I2CHW_1_DoBufferRepeatStart
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: I2CHW_1_bReadBusStatus
;
;  DESCRIPTION:
...
;     returned in A.
;       I2CHW_1_RepStart:                   equ  0x01
;       I2CHW_1_NoStop:                     equ  0x02
;       I2CHW_1_NAKnextWr:                  equ  0x04
;
;  SIDE EFFECTS:
;    The A and X registers may be modified by this or future implementations
;    of this function.  The same is true for all RAM page pointer registers in
...
;
 ...
 I2CHW_1_bReadBusStatus:
_I2CHW_1_bReadBusStatus:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >I2CHW_1_bStatus				                    ;Set the Page Pointer for LMM
   mov   A, [I2CHW_1_bStatus]                      ;return the status in A
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
