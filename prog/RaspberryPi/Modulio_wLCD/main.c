...
int main(void)
{
	UINT8 xd,yd,zd;
	MI2C_Start();
	ACM1602_Setup(&lcd1, 0x74, 0, ACM1602_ADRS0, 0);
	ACM1602_Setup(&lcd2, 0x74, 3, ACM1602_ADRS0, 0);
	ADXL345_Setup(&gsense, 0x74, 1, ADXL345_ADRS0, 0);
	LPS25H_Setup(&psense, 0x74, 1, LPS25H_ADRS0, 0);
	PCA9632_Setup(&led, 0x74, 2, PCA9632_ADRS2, 0);
	lcd1.Start(&lcd1);
	lcd2.Start(&lcd2);
